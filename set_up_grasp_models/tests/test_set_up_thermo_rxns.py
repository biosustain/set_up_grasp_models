...
class TestSetUpThermoRxns(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.file_rxns = os.path.join(self.test_folder, 'putida_with_PPP_plaintext.txt')
    ...
    def test_parse_rxns(self):
        ...
        true_rxn_list = ['R_GLCtex: m_glc__D_e <-> m_glc__D_p',
        ...
        met_bigg_ids, rxn_list = _parse_rxns(self.file_rxns)
        self.assertSetEqual(true_met_bigg_ids, met_bigg_ids)
        self.assertListEqual(true_rxn_list, rxn_list)
    ...
    def test_convert_rxn_str_to_kegg_ids(self):
        true_res = {'R_GLCtex': 'C00031 = C00031', 'R_GLCabcpp': 'C00031 + C00002 = C00031 + C00008 + C00009',
                    ...
                    'R_G6PDH2_NADP': 'C00092 + C00006 = C01236 + C00005', 'R_PGL': 'C01236 = C00345',
                    ...
                    'R_EDD': 'C00345 = C04442', 'R_EDA': 'C04442 = C00118 + C00022', 'R_PGI': 'C00092 = C00085',
                    'R_FBP': 'C00354 = C00009 + C00085', 'R_FBA': 'C00118 + C00111 = C00354',
                    'R_TPI': 'C00118 = C00111',
                    'R_GAPD': 'C00009 + C00003 + C00118 = C00004 + C00236',
                    'R_PGK': 'C00008 + C00236 = C00002 + C00197',
                    'R_PGM': 'C00197 = C00631', 'R_ENO': 'C00631 = C00074',
        ...
        rxn_list = ['R_GLCtex: m_glc__D_e <-> m_glc__D_p',
                    ...
                    'R_NADr: m_nad_c <-> m_nadh_c', 'R_NADPr: m_nadp_c <-> m_nadph_c',
                    'R_EX_pyr: m_pyr_c <-> m_pyr_e', 'R_EX_pep: m_pep_c <-> m_pep_e',
    ...
    def test_get_convert_rxns_to_kegg(self):
        ...
        with patch('builtins.input', side_effect=['']):
            rxn_dict = convert_rxns_to_kegg(self.file_rxns, map_bigg_to_kegg_ids)
    ...
    def test_get_dGs(self):
        ...
        with patch('builtins.input', side_effect=['']):
            rxn_dG_dict = get_dGs(self.file_rxns, self.file_bigg_kegg_ids, pH=7.0, ionic_strength=0.1, digits=2)
