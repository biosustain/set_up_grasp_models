...
def generate_base_model():
    ...
    file_in_stoic = os.path.join('models', 'glycolysis_example.txt')
    general_file = os.path.join('..', 'base_files', 'GRASP_general.xlsx')
    model_name = 'model_v1'
    file_out = os.path.join('models', model_name + '.xlsx')
...
def generate_model_from_base():
    ...
    file_in_stoic = os.path.join('models', 'glycolysis_example.txt')
    base_excel_file = os.path.join('models', 'model_v1_manual2_EX.xlsx')
    model_name = 'model_v2'
    file_in_mets_conc = os.path.join('models', 'met_concs.xlsx')
